        ...
        <div className="max-w-3xl mx-auto mb-8">
          <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="text-sm font-medium text-blue-800 dark:text-blue-200">Contributor's Note</h3>
            </div>
            <p className="text-sm text-blue-700 dark:text-blue-300">
              When accessing IPFS links for verification or contribution, please note that standard internet connections
              may encounter restrictions. If experiencing difficulties, try switching to mobile data or utilize{" "}
              <a
              ...
              or similar decentralized networks to ensure seamless access to all archived materials.
            </p>
          </div>
        </div>
